const PROYECTOS = [
    ...
    },
    {
        titulo: "Fake Store",
        descripcion:
            "Web con React y TypeScript, la aplicación consume una API de productos falsos para mostrar y gestionar un catálogo de artículos de manera dinámica e interactiva.",
        imagen: "Fakestore.webp",
        tecnologias: ["React JS", "TypeScript", "Sass", "Axios"],
        web: "https://guersom92.github.io/FakeStore",
        codigo: "https://github.com/Guersom92/FakeStore",
    },
    {
